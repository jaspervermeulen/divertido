    ...
    <>
      <Container>
        ...
        <div className="px-4 sm:px-8 xl:px-0">
          <TopBar>Info/Prijzen</TopBar>
        </div>
        <div className="mb-20 flex flex-col-reverse gap-12 px-4 sm:px-8 md:mt-10 md:flex-row xl:px-0">
          <div className="mt-10 md:mt-0 md:w-2/5 lg:w-3/5">
            <div>
              <div>
                <Disclosure>
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between border-b-4 border-dotted border-orange px-0 px-4 py-2 text-left">
                        <span className="font-fries text-3xl">Voor wie?</span>
                        <div
                          className={`${
                      ...
                      <Disclosure.Panel className="flex flex-col items-start pt-4 pb-2 font-fries text-2xl lg:flex-row">
                        <p className="mr-8 font-sans text-xl font-medium lg:w-1/2">
                          Iedereen is welkom! De kinderen worden in groepen
                          verdeeld volgens leeftijd.
                        </p>
                ...
                <Disclosure as="div" className="mt-6">
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between border-b-4 border-dotted border-orange px-0 px-4 py-2 text-left">
                        <span className="font-fries text-3xl">
                          Wat neem ik mee?
                        </span>
                        <div
                          className={`${
                      ...
                      <Disclosure.Panel className=" pt-4 pb-2 font-fries text-2xl">
                        <ul className="ml-6 list-disc font-sans text-xl font-medium">
                          ...
                          <li className="mt-1">
                            Alle activiteiten en materiaal
                          </li>
                          <li className="mt-1">
                            Pedagogisch geschoolde monitoren
                          </li>
                        </ul>
                      </Disclosure.Panel>
                    </>
                ...
                <Disclosure as="div" className="mt-6">
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between border-b-4 border-dotted border-orange px-0 px-4 py-2 text-left">
                        <span className="font-fries text-3xl">Uurregeling</span>
                        <div
                          className={`${
                            open ? '' : 'rotate-180 transform'
                          } h-5 w-5`}
                  ...
                  {({ open }) => (
                    <>
                      ...
                      <Disclosure.Panel className=" pt-4 pb-2 font-fries text-2xl">
                        <ul className="ml-6 list-disc font-sans text-xl font-medium">
                          <li>
                            Geef ons een attest voor uw mutualiteit. Wij vullen
                            dit met veel plezier in.
                          </li>
                          <li className="mt-1">
                          ...
                          <li className="mt-1">
                            Kennen jullie het bestaan van Sport-Axibonnen? Dit
                            is een betaalmiddel dat personen met een verhoogde
